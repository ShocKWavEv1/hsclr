...
export const ButtonTheme = defineStyleConfig({
  ...
  variants: {
    solid: (props) => ({
      border: '2px solid',
      borderColor: mode(`${props.colorScheme}.500`, `${props.colorScheme}.500`)(props),
      backgroundColor: mode(`${props.colorScheme}.500`, `${props.colorScheme}.500`)(props),
      color: 'white',
      ...
      _hover: {
        backgroundColor: mode(`${props.colorScheme}.600`, `${props.colorScheme}.600`)(props),
        borderColor: mode(`${props.colorScheme}.600`, `${props.colorScheme}.600`)(props),
        color: 'white',
        _disabled: {
          ...disabledStyles,
        },
    ...
    outline: (props) => ({
      border: '2px solid',
      borderColor: mode(`${props.colorScheme}.500`, `${props.colorScheme}.400`)(props),
      backgroundColor: 'transparent',
      color: mode(`${props.colorScheme}.500`, `${props.colorScheme}.400`)(props),
      // boxShadow: '1px 2px 2px hsl(220deg 60% 50% / 0.2), 2px 4px 4px hsl(220deg 60% 50% / 0.2), 4px 8px 8px hsl(220deg 60% 50% / 0.2), 8px 16px 16px hsl(220deg 60% 50% / 0.2), 16px 32px 32px hsl(220deg 60% 50% / 0.2);',
      _hover: {
        backgroundColor: mode(`${props.colorScheme}.500`, `${props.colorScheme}.500`)(props),
        borderColor: mode(`${props.colorScheme}.500`, `${props.colorScheme}.500`)(props),
